...
export default function RankingBoard({ position, rankings, editable = false }: { position: string; rankings: any[]; editable?: boolean }) {
  ...
  return <div className="player-ranking-board">
    ...
    <style jsx>{`@media(max-width:700px){.player-ranking-grid{grid-template-columns:minmax(0,1fr) 54px minmax(0,1fr)!important;gap:5px!important}.player-ranking-grid h2{font-size:17px!important;line-height:1.15!important;margin-bottom:14px!important}.player-sortable-row{height:68px!important;min-height:68px!important;padding:8px 7px!important;gap:6px!important;margin-bottom:8px!important}.player-sortable-logo{width:34px!important;height:34px!important;flex-basis:34px!important}.player-sortable-rank{width:20px!important;flex-basis:20px!important;font-size:12px}.player-sortable-name{font-size:12px!important;line-height:1.1!important}.player-sortable-meta{font-size:10px!important;line-height:1.1!important}.player-ranking-delta-column{display:block!important}.player-ranking-delta{height:76px!important;min-height:76px!important;font-size:15px!important}.player-ranking-actions{grid-column:1/-1}}`}</style>
  </div>;
}
